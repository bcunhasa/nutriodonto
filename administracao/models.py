...
class Diretor(models.Model):
    ...
    questao_1 = ArrayField(models.CharField(choices=DIRETOR_1, max_length=TAMANHO_OPCOES), blank=True, null=True, verbose_name='1. A escola funciona em quais turnos? (múltipla resposta)')
    ...
    questao_3 = ArrayField(models.CharField(choices=DIRETOR_3, max_length=TAMANHO_OPCOES), blank=True, null=True, verbose_name='3. A escola atende a quais etapas de ensino? (múltipla resposta)')
    ...
    questao_28 = ArrayField(models.CharField(choices=DIRETOR_28, max_length=TAMANHO_OPCOES), blank=True, null=True, verbose_name='28. Qual(is) tipo(s) de deficiência? (múltipla resposta)')
    ...
    questao_31 = ArrayField(models.CharField(choices=DIRETOR_31, max_length=TAMANHO_OPCOES), blank=True, null=True, verbose_name='31. Quais estruturas existem na escola para assegurar a acessibilidade dos alunos com necessidades especiais? (múltipla resposta)')
    ...
    questao_33 = ArrayField(models.CharField(choices=DIRETOR_33, max_length=TAMANHO_OPCOES), blank=True, null=True, verbose_name='33. A escola oferece comida (merenda escolar / almoço) para alunos de quais turnos e níveis de ensino? (múltipla resposta)')
    ...
    questao_37 = ArrayField(models.CharField(choices=DIRETOR_37, max_length=TAMANHO_OPCOES), blank=True, null=True, verbose_name='37. Que tipos de bebidas e produtos alimentícios são vendidos na cantina? (múltipla resposta)')
    ...
    questao_39 = ArrayField(models.CharField(choices=DIRETOR_39, max_length=TAMANHO_OPCOES), blank=True, null=True, verbose_name='39. Que tipos de bebidas e produtos alimentícios são vendidos no ponto alternativo de vendas? (múltipla resposta)')
