...
class Questionario(models.Model):
    ...
    questao_79 = models.CharField(choices=ALUNO_79, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='69. Nos últimos 7 dias, em quantos dias você fez atividade física por pelo menos 60 minutos (1 hora) por dia? (Some todo o tempo que você gastou em qualquer tipo de atividade física, em cada dia)')
