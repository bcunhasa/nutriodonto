...
class Questionario(models.Model):
    ...
    questao_65 = models.CharField(choices=ALUNO_65, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='66. Nos últimos sete dias, quanto tempo por dia você fez atividade física ou esporte durante as aulas de educação física na escola?')
    questao_66 = models.CharField(choices=ALUNO_66, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='67. Nos últimos 7 dias, sem contar as aulas de educação física da escola, em quantos dias você praticou alguma atividade física, como esportes, dança, ginástica, musculação, lutas ou outra atividade?')
    questao_67 = models.CharField(choices=ALUNO_67, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='68. Normalmente, quanto tempo por dia duram essas atividades (como esportes, dança, ginástica, musculação, lutas ou outra atividade) que você faz? (Sem contar as aulas de educação física)')
    questao_68 = models.CharField(choices=ALUNO_68, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='69. Nos últimos 7 dias, em quantos dias você fez atividade física por pelo menos 60 minutos (1 hora) por dia? (Some todo o tempo que você gastou em qualquer tipo de atividade física, em cada dia)')
    questao_79 = models.CharField(choices=ALUNO_79, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='70. Se você tivesse oportunidade de fazer atividade física na maioria dos dias da semana, qual seria a sua atitude?')
    questao_70 = models.CharField(choices=ALUNO_70, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='71. Em um dia de semana comum, quantas horas por dia você assiste a TV? (não contar sábado, domingo e feriado)')
    questao_71 = models.CharField(choices=ALUNO_71, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='72. Em um dia de semana comum, quanto tempo você fica sentado(a), assistindo televisão, usando computador, jogando videogame, conversando com amigos(as) ou fazendo outras atividades sentado(a)? (não contar sábado, domingo, feriados e o tempo sentado na escola)')
    questao_72 = models.CharField(choices=ALUNO_72, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='73. Alguma vez na vida, você já fumou cigarro, mesmo uma ou duas tragadas?')
    questao_73 = models.CharField(choices=ALUNO_73, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='74. Que idade você tinha quando experimentou fumar cigarro pela primeira vez?')
    questao_74 = models.CharField(choices=ALUNO_74, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='75. Nos últimos 30 dias, em quantos dias você fumou cigarros?')
    questao_75 = models.CharField(choices=ALUNO_75, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='76. Nos últimos 30 dias, em geral, como você conseguiu seus próprios cigarros?')
    questao_76 = models.CharField(choices=ALUNO_76, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='77. Nos ultimos 30 dias, alguém se recusou a lhe vender cigarros por causa de sua idade?')
    questao_77 = models.CharField(choices=ALUNO_77, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='78. Nos últimos 30 dias, em quantos dias você usou outros produtos de tabaco: cigarros de palha ou enrolados a mão, charuto, cachimbo, cigarrilha, cigarro indiano ou bali, narguilé, rapé, fumo de mascar etc.? (não incluir cigarro comum)')
    questao_78 = models.CharField(choices=ALUNO_78, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='79. Qual outro produto do tabaco você usou com mais frequência nos últimos 30 dias?')
    questao_79 = models.CharField(choices=ALUNO_79, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='80. Nos últimos 7 dias, em quantos dias pessoas fumaram na sua presença?')
    questao_80 = models.CharField(choices=ALUNO_80, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='81. Algum de seus pais ou responsáveis fuma?')
    questao_81 = models.CharField(choices=ALUNO_81, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='82. Alguma vez na vida você tomou uma dose de bebida alcoólica (uma dose equivale a uma')
    questao_82 = models.CharField(choices=ALUNO_82, max_length=TAMANHO_OPCOES, blank=True, null=True, verbose_name='lata de cerveja ou uma taça de vinho ou uma dose de cachaça ou uísque etc.)?')
...
class Exame(models.Model):
    ...
    # Periodontal
    periodontal_sangramento_1716 = models.CharField(choices=CPI_SANGRAMENTO, max_length=TAMANHO_OPCOES, null=True, verbose_name='17/16: Sangramento')
    periodontal_calculo_1716 = models.CharField(choices=CPI_CALCULO, max_length=TAMANHO_OPCOES, null=True, verbose_name='17/16: Cálculo dentário')
    periodontal_bolsa_1716 = models.CharField(choices=CPI_BOLSA, max_length=TAMANHO_OPCOES, null=True, verbose_name='17/16: Bolsa periodontal')
    
    periodontal_sangramento_11 = models.CharField(choices=CPI_SANGRAMENTO, max_length=TAMANHO_OPCOES, null=True, verbose_name='11: Sangramento')
    periodontal_calculo_11 = models.CharField(choices=CPI_CALCULO, max_length=TAMANHO_OPCOES, null=True, verbose_name='11: Cálculo dentário')
    periodontal_bolsa_11 = models.CharField(choices=CPI_BOLSA, max_length=TAMANHO_OPCOES, null=True, verbose_name='11: Bolsa periodontal')

    periodontal_sangramento_2627 = models.CharField(choices=CPI_SANGRAMENTO, max_length=TAMANHO_OPCOES, null=True, verbose_name='26/27: Sangramento')
    periodontal_calculo_2627 = models.CharField(choices=CPI_CALCULO, max_length=TAMANHO_OPCOES, null=True, verbose_name='26/27: Cálculo dentário')
    periodontal_bolsa_2627 = models.CharField(choices=CPI_BOLSA, max_length=TAMANHO_OPCOES, null=True, verbose_name='26/27: Bolsa periodontal')

    periodontal_sangramento_3736 = models.CharField(choices=CPI_SANGRAMENTO, max_length=TAMANHO_OPCOES, null=True, verbose_name='37/36: Sangramento')
    periodontal_calculo_3736 = models.CharField(choices=CPI_CALCULO, max_length=TAMANHO_OPCOES, null=True, verbose_name='37/36: Cálculo dentário')
    periodontal_bolsa_3736 = models.CharField(choices=CPI_BOLSA, max_length=TAMANHO_OPCOES, null=True, verbose_name='37/36: Bolsa periodontal')

    periodontal_sangramento_31 = models.CharField(choices=CPI_SANGRAMENTO, max_length=TAMANHO_OPCOES, null=True, verbose_name='31: Sangramento')
    periodontal_calculo_31 = models.CharField(choices=CPI_CALCULO, max_length=TAMANHO_OPCOES, null=True, verbose_name='31: Cálculo dentário')
    periodontal_bolsa_31 = models.CharField(choices=CPI_BOLSA, max_length=TAMANHO_OPCOES, null=True, verbose_name='31: Bolsa periodontal')

    periodontal_sangramento_4647 = models.CharField(choices=CPI_SANGRAMENTO, max_length=TAMANHO_OPCOES, null=True, verbose_name='46/47: Sangramento')
    periodontal_calculo_4647 = models.CharField(choices=CPI_CALCULO, max_length=TAMANHO_OPCOES, null=True, verbose_name='46/47: Cálculo dentário')
    periodontal_bolsa_4647 = models.CharField(choices=CPI_BOLSA, max_length=TAMANHO_OPCOES, null=True, verbose_name='46/47: Bolsa periodontal')
