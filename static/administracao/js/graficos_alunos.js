...
function carregaDados(questao) {
    if (questao == "#aluno_por_escola") {
        return [
            ...
            { label: "Escola Municipal de T.I. Marcos Freire", data: aluno_por_escola[26] },
            { label: "Escola municipal de T.I. Anisio Spínola Teixeira", data: aluno_por_escola[27] },
            { label: "Escola municipal de T.I. Almirante Tamandaré", data: aluno_por_escola[28] },
        ];
