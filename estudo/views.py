...
class EstudoView(LoginRequired, View):
    ...
    def get(self, request):
        ...
        if request.session['lang'] == 'en':
            idade_geral = ['General', 0, 0, 0, 0, 0, 0, 0, 0]
            idade_escolas = [
                ['Padre Josimo M. Tavares Municipal School',    0, 0, 0, 0, 0, 0, 0, 0],
                ['Beatriz Rodrigues da Silva Municipal School',         0, 0, 0, 0, 0, 0, 0, 0],
                ['Mestre Pacífico S. Campos Municipal School',          0, 0, 0, 0, 0, 0, 0, 0],
                ['Luiz Gonzaga Municipal School',                       0, 0, 0, 0, 0, 0, 0, 0],
                ['Monsenhor Pedro P. Piagem Municipal School',  0, 0, 0, 0, 0, 0, 0, 0],
                ['Daniel Batista Municipal School',             0, 0, 0, 0, 0, 0, 0, 0],
                ['Anne Frank Municipal School',                         0, 0, 0, 0, 0, 0, 0, 0],
                ['Henrique Talone Pinheiro Municipal School',           0, 0, 0, 0, 0, 0, 0, 0],
                ['Aprigio T. de Matos Municipal School',        0, 0, 0, 0, 0, 0, 0, 0],
                ['Vinícius de Moraes Municipal School',         0, 0, 0, 0, 0, 0, 0, 0],
                ['Darcy Ribeiro Municipal School',                      0, 0, 0, 0, 0, 0, 0, 0],
                ['Antônio G. de Carvalho Filho Municipal School',       0, 0, 0, 0, 0, 0, 0, 0],
                ['Antônio Carlos Jobim Municipal School',               0, 0, 0, 0, 0, 0, 0, 0],
                ['Almirante Tamandare Municipal School',         0, 0, 0, 0, 0, 0, 0, 0],
                ['Anisio Spenola Teixeira Municipal School',    0, 0, 0, 0, 0, 0, 0, 0],
                ['Thiago Barbosa Municipal School',                     0, 0, 0, 0, 0, 0, 0, 0],
                ['Aurélio Buarque de Holanda Municipal School',         0, 0, 0, 0, 0, 0, 0, 0],
                ['Margarida Gonçalves Municipal School',        0, 0, 0, 0, 0, 0, 0, 0],
                ['Professor Sávia F. Jacome Municipal School',          0, 0, 0, 0, 0, 0, 0, 0],
                ['Jorge Amado Municipal School',                        0, 0, 0, 0, 0, 0, 0, 0],
                ['Caroline C. C. da Silva Municipal School',    0, 0, 0, 0, 0, 0, 0, 0],
                ['Maria Rosa de Castro Sales Municipal School',         0, 0, 0, 0, 0, 0, 0, 0],
                ['Euridice F. de Mello Municipal School',       0, 0, 0, 0, 0, 0, 0, 0],
                ['Maria Júlia Amorim Rodrigues Municipal School',       0, 0, 0, 0, 0, 0, 0, 0],
                ['Crispim Pereira de Alencar Municipal School',         0, 0, 0, 0, 0, 0, 0, 0],
                ['Sueli Pereira A. Reche Municipal School',     0, 0, 0, 0, 0, 0, 0, 0],
                ['Luiz Nunes de Oliveira Municipal School',     0, 0, 0, 0, 0, 0, 0, 0],
                ['Marcos Freire Municipal School',    0, 0, 0, 0, 0, 0, 0, 0],
                ['João Beltrão Municipal School',               0, 0, 0, 0, 0, 0, 0, 0],
            ]
            ...
            idade_macrorregioes = [
                ...
                ['Center-south', 0, 0, 0, 0, 0, 0, 0, 0],
                ['South',        0, 0, 0, 0, 0, 0, 0, 0],
                ['Rural area', 0, 0, 0, 0, 0, 0, 0, 0],
            ]
            
            raca_geral = ['General', 0, 0, 0, 0, 0]
            raca_escolas = [
                ['Padre Josimo M. Tavares Municipal School',    0, 0, 0, 0, 0],
                ['Beatriz Rodrigues da Silva Municipal School',         0, 0, 0, 0, 0],
                ['Mestre Pacífico S. Campos Municipal School',          0, 0, 0, 0, 0],
                ['Luiz Gonzaga Municipal School',                       0, 0, 0, 0, 0],
                ['Monsenhor Pedro P. Piagem Municipal School',  0, 0, 0, 0, 0],
                ['Daniel Batista Municipal School',             0, 0, 0, 0, 0],
                ['Anne Frank Municipal School',                         0, 0, 0, 0, 0],
                ['Henrique Talone Pinheiro Municipal School',           0, 0, 0, 0, 0],
                ['Aprigio T. de Matos Municipal School',        0, 0, 0, 0, 0],
                ['Vinícius de Moraes Municipal School',         0, 0, 0, 0, 0],
                ['Darcy Ribeiro Municipal School',                      0, 0, 0, 0, 0],
                ['Antônio G. de Carvalho Filho Municipal School',       0, 0, 0, 0, 0],
                ['Antônio Carlos Jobim Municipal School',               0, 0, 0, 0, 0],
                ['Almirante Tamandare Municipal School',         0, 0, 0, 0, 0],
                ['Anisio Spenola Teixeira Municipal School',    0, 0, 0, 0, 0],
                ['Thiago Barbosa Municipal School',                     0, 0, 0, 0, 0],
                ['Aurélio Buarque de Holanda Municipal School',         0, 0, 0, 0, 0],
                ['Margarida Gonçalves Municipal School',        0, 0, 0, 0, 0],
                ['Professor Sávia F. Jacome Municipal School',          0, 0, 0, 0, 0],
                ['Jorge Amado Municipal School',                        0, 0, 0, 0, 0],
                ['Caroline C. C. da Silva Municipal School',    0, 0, 0, 0, 0],
                ['Maria Rosa de Castro Sales Municipal School',         0, 0, 0, 0, 0],
                ['Euridice F. de Mello Municipal School',       0, 0, 0, 0, 0],
                ['Maria Júlia Amorim Rodrigues Municipal School',       0, 0, 0, 0, 0],
                ['Crispim Pereira de Alencar Municipal School',         0, 0, 0, 0, 0],
                ['Sueli Pereira A. Reche Municipal School',     0, 0, 0, 0, 0],
                ['Luiz Nunes de Oliveira Municipal School',     0, 0, 0, 0, 0],
                ['Marcos Freire Municipal School',    0, 0, 0, 0, 0],
                ['João Beltrão Municipal School',               0, 0, 0, 0, 0],
            ]
            ...
            raca_macrorregioes = [
                ['North',      0, 0, 0, 0, 0],
                ['Center-south', 0, 0, 0, 0, 0],
                ['South',        0, 0, 0, 0, 0],
                ['Rural area', 0, 0, 0, 0, 0],
            ]
            
            sexo_geral = ['General', 0, 0, 0, 0]
            sexo_escolas = [
                ['Padre Josimo M. Tavares Municipal School',    0, 0, 0, 0],
                ['Beatriz Rodrigues da Silva Municipal School',         0, 0, 0, 0],
                ['Mestre Pacífico S. Campos Municipal School',          0, 0, 0, 0],
                ['Luiz Gonzaga Municipal School',                       0, 0, 0, 0],
                ['Monsenhor Pedro P. Piagem Municipal School',  0, 0, 0, 0],
                ['Daniel Batista Municipal School',             0, 0, 0, 0],
                ['Anne Frank Municipal School',                         0, 0, 0, 0],
                ['Henrique Talone Pinheiro Municipal School',           0, 0, 0, 0],
                ['Aprigio T. de Matos Municipal School',        0, 0, 0, 0],
                ['Vinícius de Moraes Municipal School',         0, 0, 0, 0],
                ['Darcy Ribeiro Municipal School',                      0, 0, 0, 0],
                ['Antônio G. de Carvalho Filho Municipal School',       0, 0, 0, 0],
                ['Antônio Carlos Jobim Municipal School',               0, 0, 0, 0],
                ['Almirante Tamandare Municipal School',         0, 0, 0, 0],
                ['Anisio Spenola Teixeira Municipal School',    0, 0, 0, 0],
                ['Thiago Barbosa Municipal School',                     0, 0, 0, 0],
                ['Aurélio Buarque de Holanda Municipal School',         0, 0, 0, 0],
                ['Margarida Gonçalves Municipal School',        0, 0, 0, 0],
                ['Professor Sávia F. Jacome Municipal School',          0, 0, 0, 0],
                ['Jorge Amado Municipal School',                        0, 0, 0, 0],
                ['Caroline C. C. da Silva Municipal School',    0, 0, 0, 0],
                ['Maria Rosa de Castro Sales Municipal School',         0, 0, 0, 0],
                ['Euridice F. de Mello Municipal School',       0, 0, 0, 0],
                ['Maria Júlia Amorim Rodrigues Municipal School',       0, 0, 0, 0],
                ['Crispim Pereira de Alencar Municipal School',         0, 0, 0, 0],
                ['Sueli Pereira A. Reche Municipal School',     0, 0, 0, 0],
                ['Luiz Nunes de Oliveira Municipal School',     0, 0, 0, 0],
                ['Marcos Freire Municipal School',    0, 0, 0, 0],
                ['João Beltrão Municipal School',               0, 0, 0, 0],
            ]
            ...
            sexo_macrorregioes = [
                ['North',      0, 0, 0, 0],
                ['Center-south', 0, 0, 0, 0],
                ['South',        0, 0, 0, 0],
                ['Rural area', 0, 0, 0, 0],
            ]
            
            # Questões sobre CPO-D (nome, dentes considerados, total de indivíduos)
            cpod_geral = ['General', 0, 0]
            cpod_escolas = [
                ['Padre Josimo M. Tavares Municipal School',    0, 0],
                ['Beatriz Rodrigues da Silva Municipal School',         0, 0],
                ['Mestre Pacífico S. Campos Municipal School',          0, 0],
                ['Luiz Gonzaga Municipal School',                       0, 0],
                ['Monsenhor Pedro P. Piagem Municipal School',  0, 0],
                ['Daniel Batista Municipal School',             0, 0],
                ['Anne Frank Municipal School',                         0, 0],
                ['Henrique Talone Pinheiro Municipal School',           0, 0],
                ['Aprigio T. de Matos Municipal School',        0, 0],
                ['Vinícius de Moraes Municipal School',         0, 0],
                ['Darcy Ribeiro Municipal School',                      0, 0],
                ['Antônio G. de Carvalho Filho Municipal School',       0, 0],
                ['Antônio Carlos Jobim Municipal School',               0, 0],
                ['Almirante Tamandare Municipal School',         0, 0],
                ['Anisio Spenola Teixeira Municipal School',    0, 0],
                ['Thiago Barbosa Municipal School',                     0, 0],
                ['Aurélio Buarque de Holanda Municipal School',         0, 0],
                ['Margarida Gonçalves Municipal School',        0, 0],
                ['Professor Sávia F. Jacome Municipal School',          0, 0],
                ['Jorge Amado Municipal School',                        0, 0],
                ['Caroline C. C. da Silva Municipal School',    0, 0],
                ['Maria Rosa de Castro Sales Municipal School',         0, 0],
                ['Euridice F. de Mello Municipal School',       0, 0],
                ['Maria Júlia Amorim Rodrigues Municipal School',       0, 0],
                ['Crispim Pereira de Alencar Municipal School',         0, 0],
                ['Sueli Pereira A. Reche Municipal School',     0, 0],
                ['Luiz Nunes de Oliveira Municipal School',     0, 0],
                ['Marcos Freire Municipal School',    0, 0],
                ['João Beltrão Municipal School',               0, 0],
            ]
