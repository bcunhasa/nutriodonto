...
class EstudoView(LoginRequired, View):
    ...
    def get(self, request):
        ...
        for exame in exames:
            ...
            if exame.carie_coroa_18 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_17 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_16 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_15 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_14 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_13 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_12 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_11 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_21 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_22 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_23 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_24 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_25 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_26 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_27 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_28 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_38 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_37 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_36 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_35 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_34 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_33 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_32 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_31 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_41 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_42 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_43 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_44 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_45 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_46 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_47 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
            if exame.carie_coroa_48 == '1': entra_contagem = 1; cpod_geral[1] += 1; cpod_escolas[escola][1] += 1; cpod_macrorregioes[macrorregiao][1] += 1; cpod_territorios_saude[territorio_saude][1] += 1
